...
public class SimpleBloomFilter<E> implements Set<E>, Serializable {
   ...
   * Bloom Filter, and also you should specify the number of items you expect to
   * add. The latter is used to choose some optimal internal values to minimize
   * the false-positive rate (which can be estimated with
   ...
   *         estimated using the expectedFalsePositiveProbability() method.
   */
